...
With this add-on, you can tell Codex or Claude to inspect contacts, lists, templates, campaigns, or transactional mail flows and then make the needed change without the usual admin-panel grind.
